                ...
                <tr key={d.id}>
                  ...
                  <td className="w-0">
                    <div className="flex items-center gap-0.5">
                      ...
                      <div className="tooltip" data-tip="Students">
                        <button type="button" className="btn btn-ghost btn-xs btn-square" onClick={() => alert(`${count ?? 0} students assigned to ${d.bus === "—" ? "no bus" : d.bus}`)}>
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4">
                      ...
                      <div className="tooltip" data-tip={effectiveStatus === "inactive" ? "Mark Active" : "Mark Inactive"}>
                        <button type="button" className="btn btn-ghost btn-xs btn-square" onClick={() => toggleStatus(d.id)}>
                      ...
                      <div className="tooltip" data-tip="Schedule">
                        <button type="button" className="btn btn-ghost btn-xs btn-square" onClick={() => alert(d.schedule !== "—" ? `Schedule: ${d.schedule}` : "No schedule assigned")}>
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4">
